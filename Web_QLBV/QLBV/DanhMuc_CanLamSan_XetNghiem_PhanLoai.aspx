<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DanhMuc_CanLamSan_XetNghiem_PhanLoai.aspx.cs" Inherits="QLBV.DanhMuc_CanLamSan_XetNghiem_PhanLoai" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContent" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="font-weight:bold;padding-left:170px">DANH MỤC LOẠI XÉT NGHIỆM</h1>
    ...
    <asp:Panel ID="pn_pan" runat="server" Width="500px" BorderStyle="Double">
        <asp:GridView ID="gv_PatientList" runat="server" Width="100%"
            ...
            style="margin-top: 0px">
                <Columns>
                    <asp:TemplateField HeaderText="Mã Loại Xét Nghiệm">
                        <ItemTemplate>
                            <asp:LinkButton ID="lb_ID" runat="server" Text='<%# Eval("MaLoaiXetNghiem") %>'
                               OnClick="LoadList" ></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="Tên Loại Xét Nghiệm" DataField="TenLoaiXetNghiem"
                        SortExpression="TenLoaiXetNghiem"/>
                </Columns>
        </asp:GridView>
    </asp:Panel>
    <br />
