<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DanhMuc_CanLamSan_SieuAm_KetQua_Phieu.aspx.cs" Inherits="QLBV.DanhMuc_CanLamSan_SieuAm_KetQua_Phieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContent" runat="server">
    <ul>
        <li><a href="DanhMuc_CanLamSan_SieuAm_KetQua_BenhNhan.aspx">Bệnh nhân</a></li>
        <li><a href="DanhMuc_CanLamSan_SieuAm_KetQua_DSPhieu.aspx">Danh sách phiếu siêu âm</a></li>
        <li><a href="DanhMuc_CanLamSan_SieuAm_KetQua_Phieu.aspx">Phiếu siêu âm</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="font-weight:bold;padding-left:170px;">Phiếu Siêu Âm</h1><br />
    ...
    <table>
        <tr>
            ...
            <td>Chỉ tiêu siêu âm</td>
            <td><asp:DropDownList ID="ddl_ChiTieu" runat="server" Width="120px" 
                    DataSourceID="SqlDataSource1" DataTextField="TenSieuAm" 
                    DataValueField="MaSieuAm"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:DB_WebBenhVienConnectionString %>" 
                    SelectCommand="SELECT * FROM [tbl_ChiTietSieuAm]"></asp:SqlDataSource>
            </td>
            <td>Ngày yêu cầu</td>
