<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DanhMuc_CanLamSan_SieuAm_KetQua_DSPhieu.aspx.cs" Inherits="QLBV.DanhMuc_CanLamSan_SieuAm_KetQua_DSPhieu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pn_pan" runat="server" ScrollBars="Vertical"  Width="900px" BorderStyle="Double">
        <asp:GridView ID="gv_PatientList" runat="server" Width="100%" fon
