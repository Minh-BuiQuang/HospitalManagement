<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DanhMuc_CanLamSan_XQuang_KetQua_Phieu.aspx.cs" Inherits="QLBV.DanhMuc_CanLamSan_XQuang_KetQua_Phieu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="font-weight:bold;padding-left:170px;">Phiếu X-Quang</h1><br />
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="ddl_ChiTieu" runat="server" Width="120px" 
                    DataSourceID="SqlDataSource1" DataTextField="TenXQuang" 
                    DataValueField="MaXQuang"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:DB_WebBenhVienConnectionString %>" 
                    SelectCommand="SELECT * FROM [tbl_ChiTietXQuang]"></asp:SqlDataSource>
            </td>
            <td>Ngày yêu cầu</td>
                            ...
                            <Content>
                                <asp:Panel ID="pn_image" runat="server" Width="300px">
                                    <asp:FileUpload ID="fu_link" runat="server" EnableTheming="true" Height="20px" 
                                        ...
                                        <asp:Button ID="btn_print" runat="server" Text="In phiếu" /><br />
