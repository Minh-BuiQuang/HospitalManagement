...
namespace QLBV
{
    public partial class DanhMuc_CanLamSan_SieuAm_KetQua : System.Web.UI.Page
    {
        ...
        protected void gv_DanhSach_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                colID.NavigateUrl = "DanhMuc_CanLamSan_SieuAm_KetQua_DSPhieu.aspx?id=" + dataItem[0].ToString();
