<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DanhMuc_DichTruyen.aspx.cs" Inherits="QLBV.DanhMuc_Dichtruyen1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContent" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="font-weight:bold;padding-left:170px">DANH DỊCH TRUYỀN</h1>
    <asp:label ID="lbl_error" runat="server" Font-Bold="true" ForeColor="Red"></asp:label>
    <table>
        <tr>
            <td>Mã dịch truyền :</td>
            <td>
                <asp:TextBox ID="tb_MaDichTruyen" runat="server" Enabled="false" Width="50px"></asp:TextBox>
            </td>
            <td>Tên loại bệnh :</td>
            <td>
                <asp:TextBox ID="tb_TenDichTruyen" runat="server" Enabled="false" Width="250px"></asp:TextBox>
            </td>
        </tr>
    </table>
            ...
            style="margin-top: 0px">
                <Columns>
                    <asp:TemplateField HeaderText="Mã Dịch Truyền">
                        <ItemTemplate>
                            <asp:LinkButton ID="lb_ID" runat="server" Text='<%# Eval("MaDichTruyen") %>' 
                               OnClick="LoadList" ></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="Tên Dịch Truyền" DataField="TenDichTruyen"
                        SortExpression="TenDichTruyen"/>
                </Columns>
        </asp:GridView>
    </asp:Panel>
    <br />
